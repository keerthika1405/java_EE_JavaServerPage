...
<section id="products" class="section">
    <div class="container">
        ...
        %>
        <span id="size" title="<%=(ArrayList) session.getAttribute("noofproducts")%>">Items in Cart: <%=((ArrayList) session.getAttribute("noofproducts")).size()%></span>
        <%
        } else {
        %>
    ...
    <div class="productContainer">
        ...
        <%
           List<product> prod = (ArrayList) request.getAttribute("product");
